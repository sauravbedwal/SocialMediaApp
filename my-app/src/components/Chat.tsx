    ...
    <div className='container'>
        ...
        <div style={{display: "flex", alignItems: "center"}}>
            ...
            <div className='chatFriendRepeat'>
              <p>
                Its great, UK is awesome, espesially London. New job is good so far! How about you?</p>
            </div>
        ...
        <div style={{display: "flex", alignItems: "center"}}>
            <div className="followersMenuAvatar">
             ...
             <div className='chatOwnerRepeat'>
              <p>
                 But I don't know what to sell. Maybe I will sell stones and water</p>
            </div>
...
<div className='secondary-btn'>
          <input className='chatWhite-btn' type="text" placeholder='Say something' />
         </div>
  </div>
